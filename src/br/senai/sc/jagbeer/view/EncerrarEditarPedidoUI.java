								...
								.addGroup(gl_panel.createSequentialGroup()
									...
									.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING)
										...
										.addGroup(gl_panel.createSequentialGroup()
											...
											.addPreferredGap(ComponentPlacement.RELATED)))
									.addComponent(lblDdmmyyyy, GroupLayout.PREFERRED_SIZE, 93, GroupLayout.PREFERRED_SIZE))
									...
									.addGroup(Alignment.TRAILING, gl_panel.createSequentialGroup()
										...
										.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
											.addGroup(gl_panel.createSequentialGroup()
												...
												.addComponent(btnExcluirItem, GroupLayout.PREFERRED_SIZE, 162, GroupLayout.PREFERRED_SIZE)
												.addGap(44)
												.addComponent(btnEncerrar, GroupLayout.PREFERRED_SIZE, 161, GroupLayout.PREFERRED_SIZE))
											.addGroup(gl_panel.createSequentialGroup()
												.addPreferredGap(ComponentPlacement.RELATED)
